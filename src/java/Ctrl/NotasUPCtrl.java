 ...
 * @author HP 15
 */
public class NotasUPCtrl extends GenericForwardComposer {
    ...
    public void onChange$bimestre(Event e) {
        ...
        if (op == 0) {
            us = renglonDal.verNota(grado.getSelectedItem().getValue().toString(),
                    estudiante.getSelectedItem().getValue().toString(), materia.getSelectedItem().getValue().toString(),
                    bimestre.getSelectedItem().getValue().toString());
            if (us.getResp().equals("1")) {
                nota.setText(us.getNota());
