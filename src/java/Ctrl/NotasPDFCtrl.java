 ...
 * @author HP 15
 */
public class NotasPDFCtrl extends GenericForwardComposer{
    ...
    private Combobox bimestre;
     ...
     public void onClick$btnDescargar(Event e) throws SQLException, ClassNotFoundException {
      ...
      public void GeneraPDFTodas(String anio, String user,String bimestre1) throws SQLException, ClassNotFoundException {
        ...
        alldata = rd.REGselectTodas(anio,user,bimestre.getSelectedItem().getValue().toString());
        ...
        try {
            ...
            float anchosFilas[] = {0.1f, 0.2f, 0.7f, 0.7f,0.7f, 0.2f};//Anchos de las filas
            PdfPTable tabla = new PdfPTable(anchosFilas);
            String rotulosColumnas[] = {"No.","CODIGO", "NOMBRE","GRADO", "CURSO", "NOTA"};//Rotulos de las columnas 
...
// ParrafoHoja.add(new Paragraph("               Kardex: "));
            ...
            AMedia amedia = new AMedia("NOTAS.PDF", "PDF", "application/file", baos.toByteArray());
